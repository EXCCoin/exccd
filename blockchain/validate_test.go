...
func recalculateMsgBlockMerkleRootsSize(msgBlock *wire.MsgBlock) {
	tempBlock := exccutil.NewBlock(msgBlock)
...
func TestBlockValidationRules(t *testing.T) {
	...
	b142test := exccutil.NewBlock(earlySSGen142)
	...
	block153, err := exccutil.NewBlockFromBytes(blockChain[int64(testsIdx1)])
	if err != nil {
		t.Errorf("NewBlockFromBytes error: %v", err.Error())
	}
	...
	b153test := exccutil.NewBlock(missingParent153)
	...
	b153test = exccutil.NewBlock(ssrtxPayeesMismatch153)
	...
	b153test = exccutil.NewBlock(badSSRtxPayee153)
	...
	b153test = exccutil.NewBlock(badSSRtx153)
	...
	b153test = exccutil.NewBlock(block153MsgBlock)
	...
	b154test := exccutil.NewBlock(block154MsgBlock)
	...
	b154test = exccutil.NewBlock(nonChosenTicket154)
	...
	b154test = exccutil.NewBlock(spendTaggedIn154)
	...
	b154test = exccutil.NewBlock(spendTaggedOut154)
	...
	b154test = exccutil.NewBlock(errTxTreeIn154)
	...
	b154test = exccutil.NewBlock(badScrVal154)
	...
	b154test = exccutil.NewBlock(badScrValS154)
	...
	b154test = exccutil.NewBlock(invalMissingInsS154)
	...
	b154test = exccutil.NewBlock(spendZeroValueIn154)
	...
	b166test := exccutil.NewBlock(spendInvalid166)
	...
	orgAddr, _ := exccutil.DecodeAddress("ScuQxvveKGfpG1ypt6u27F99Anf7EW3cqhq")
	pkScript, _ := txscript.GenerateSStxAddrPush(orgAddr,
		exccutil.Amount(29702992297), 0x0000)
	...
	b166test = exccutil.NewBlock(sstxSpendInvalid166)
	...
	pkScript, _ = txscript.GenerateSStxAddrPush(orgAddr,
		exccutil.Amount(2345438298), 0x0000)
	txOut = wire.NewTxOut(int64(0), pkScript)
	sstxToUse166.AddTxOut(txOut)
	pkScript, _ = txscript.PayToSStxChange(orgAddr)
	txOut = wire.NewTxOut(0, pkScript)
	...
	b166test = exccutil.NewBlock(sstxSpend2Invalid166)
	...
	b166test = exccutil.NewBlock(sstxSpend3Invalid166)
	...
	b166test = exccutil.NewBlock(regTxSpendStakeIn166)
...
func TestCheckBlockSanity(t *testing.T) {
	params := &chaincfg.SimNetParams
	timeSource := NewMedianTime()
	block := exccutil.NewBlock(&badBlock)
