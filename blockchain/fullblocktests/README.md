...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/EXCCoin/exccd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/EXCCoin/exccd/blockchain/fullblocktests
```
