...
func IsFinalizedTransaction(tx *exccutil.Tx, blockHeight int64, blockTime time.Time) bool {
...
func (b *BlockChain) maybeAcceptBlock(block *exccutil.Block, flags BehaviorFlags) (bool, error) {
