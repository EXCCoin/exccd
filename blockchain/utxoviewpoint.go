...
func (view *UtxoViewpoint) AddTxOuts(tx *exccutil.Tx, blockHeight int64, blockIndex uint32) {
	msgTx := tx.MsgTx()
...
func (view *UtxoViewpoint) connectTransaction(tx *exccutil.Tx, blockHeight int64, blockIndex uint32, stxos *[]spentTxOut) error {
	msgTx := tx.MsgTx()
...
func (b *BlockChain) connectTransactions(view *UtxoViewpoint, block *exccutil.Block, parent *exccutil.Block, stxos *[]spentTxOut) error {
...
func (b *BlockChain) disconnectTransactions(view *UtxoViewpoint, block *exccutil.Block, parent *exccutil.Block, stxos []spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactionSlice(transactions []*exccutil.Tx, height int64, stxosPtr *[]spentTxOut) (int, error) {
	if stxosPtr == nil {
...
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block, parent *exccutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *exccutil.Tx, treeValid bool) (*UtxoViewpoint, error) {
	b.chainLock.RLock()
