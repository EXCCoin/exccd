...
//
// This function is safe for concurrent access.
func (b *BlockChain) TicketsWithAddress(address exccutil.Address) ([]chainhash.Hash, error) {
	b.chainLock.RLock()
	sn := b.bestNode.stakeNode
	b.chainLock.RUnlock()
...
func (b *BlockChain) TicketPoolValue() (exccutil.Amount, error) {
	b.chainLock.RLock()
	sn := b.bestNode.stakeNode
	b.chainLock.RUnlock()
	...
	return exccutil.Amount(amt), nil
}
