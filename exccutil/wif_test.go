...
func TestEncodeDecodeWIF(t *testing.T) {
	...
	wif1, err := exccutil.NewWIF(priv1, &chaincfg.MainNetParams, chainec.ECTypeSecp256k1, false)
	if err != nil {
		t.Fatal(err)
	}
	wif2, err := exccutil.NewWIF(priv2, &chaincfg.TestNet2Params, chainec.ECTypeSecp256k1, true)
	if err != nil {
		t.Fatal(err)
	}
