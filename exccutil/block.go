...
// Tx returns a wrapped transaction (exccutil.Tx) for the transaction at the
...
// STx returns a wrapped transaction (exccutil.Tx) for the stake transaction at
...
// Transactions returns a slice of wrapped transactions (exccutil.Tx) for all
...
// instead provides easy access to wrapped versions (exccutil.Tx) of them.
