...
func TestBtcWalletExtCmds(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			newCmd: func() (interface{}, error) {
				return exccjson.NewCmd("createnewaccount", "acct")
			},
			staticCmd: func() interface{} {
				return exccjson.NewCreateNewAccountCmd("acct")
			},
			marshalled: `{"jsonrpc":"1.0","method":"createnewaccount","params":["acct"],"id":1}`,
			unmarshalled: &exccjson.CreateNewAccountCmd{
				Account: "acct",
			},
		},
		{
			name: "importaddress",
			newCmd: func() (interface{}, error) {
				return exccjson.NewCmd("importaddress", "1Address")
			},
			staticCmd: func() interface{} {
				return exccjson.NewImportAddressCmd("1Address", nil)
			},
			marshalled: `{"jsonrpc":"1.0","method":"importaddress","params":["1Address"],"id":1}`,
			unmarshalled: &exccjson.ImportAddressCmd{
				Address: "1Address",
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return exccjson.NewCmd("importaddress", "1Address", false)
			},
			staticCmd: func() interface{} {
				return exccjson.NewImportAddressCmd("1Address", exccjson.Bool(false))
			},
		...
		},
		{
			name: "importpubkey",
			newCmd: func() (interface{}, error) {
				return exccjson.NewCmd("importpubkey", "031234")
			},
			staticCmd: func() interface{} {
				return exccjson.NewImportPubKeyCmd("031234", nil)
			},
			marshalled: `{"jsonrpc":"1.0","method":"importpubkey","params":["031234"],"id":1}`,
			unmarshalled: &exccjson.ImportPubKeyCmd{
				PubKey: "031234",
				Rescan: exccjson.Bool(true),
			},
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return exccjson.NewCmd("importpubkey", "031234", false)
			},
			staticCmd: func() interface{} {
				return exccjson.NewImportPubKeyCmd("031234", exccjson.Bool(false))
			},
		...
		},
		{
			name: "renameaccount",
			newCmd: func() (interface{}, error) {
				return exccjson.NewCmd("renameaccount", "oldacct", "newacct")
			},
			staticCmd: func() interface{} {
				return exccjson.NewRenameAccountCmd("oldacct", "newacct")
			},
			marshalled: `{"jsonrpc":"1.0","method":"renameaccount","params":["oldacct","newacct"],"id":1}`,
			unmarshalled: &exccjson.RenameAccountCmd{
				OldAccount: "oldacct",
				NewAccount: "newacct",
			},
		},
