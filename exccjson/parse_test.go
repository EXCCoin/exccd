...
func TestEncodeConcatenatedHashes(t *testing.T) {
	...
	for j := 0; j < len(hashSlice)+1; j++ {
		...
		// Encode to string
		concatenated := exccjson.EncodeConcatenatedHashes(hashSlice[:j])
		// Verify output
...
func TestDecodeConcatenatedHashes(t *testing.T) {
	...
	decodedHashes, err := exccjson.DecodeConcatenatedHashes(concatenatedHashes)
	if err != nil {
...
func TestEncodeConcatenatedVoteBits(t *testing.T) {
	...
	encodedResults, err := exccjson.EncodeConcatenatedVoteBits(testVbs)
	if err != nil {
	...
	_, err = exccjson.EncodeConcatenatedVoteBits(testVbs)
	if err == nil {
...
func TestDecodeConcatenatedVoteBits(t *testing.T) {
	...
	decodedSlice, err :=
		exccjson.DecodeConcatenatedVoteBits(encodedBytesStr)
	if err != nil {
	...
	_, err = exccjson.DecodeConcatenatedVoteBits(encodedBytesStr)
	if err == nil {
...
func TestInvalidDecodeConcatenatedHashes(t *testing.T) {
	...
	for _, str := range testStrings {
		_, err := exccjson.DecodeConcatenatedHashes(str.str)
		if err == nil {
