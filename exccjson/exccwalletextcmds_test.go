...
func TestDcrWalletExtCmds(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			newCmd: func() (interface{}, error) {
				return exccjson.NewCmd("sweepaccount", "default", "DsUZxxoHJSty8DCfwfartwTYbuhmVct7tJu", 6, 0.05)
			},
			staticCmd: func() interface{} {
				return exccjson.NewSweepAccountCmd("default", "DsUZxxoHJSty8DCfwfartwTYbuhmVct7tJu",
			...
			unmarshalled: &exccjson.SweepAccountCmd{
		...
		},
		{
			...
			newCmd: func() (interface{}, error) {
				return exccjson.NewCmd("sweepaccount", "default", "DsUZxxoHJSty8DCfwfartwTYbuhmVct7tJu")
			},
			staticCmd: func() interface{} {
				return exccjson.NewSweepAccountCmd("default", "DsUZxxoHJSty8DCfwfartwTYbuhmVct7tJu", nil, nil)
			},
