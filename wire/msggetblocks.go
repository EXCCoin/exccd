...
// MsgGetBlocks implements the Message interface and represents a ExchangeCoin
...
// NewMsgGetBlocks returns a new ExchangeCoin getblocks message that conforms to the
