...
// MsgGetAddr implements the Message interface and represents a ExchangeCoin
...
// NewMsgGetAddr returns a new ExchangeCoin getaddr message that conforms to the
