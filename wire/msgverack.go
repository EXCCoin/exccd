...
// MsgVerAck defines a ExchangeCoin verack message which is used for a peer to
...
// NewMsgVerAck returns a new ExchangeCoin verack message that conforms to the
// Message interface.
