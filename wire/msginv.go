...
// MsgInv implements the Message interface and represents a ExchangeCoin inv message.
...
// NewMsgInv returns a new ExchangeCoin inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new ExchangeCoin inv message that conforms to the
