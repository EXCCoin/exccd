...
// MsgMerkleBlock implements the Message interface and represents a ExchangeCoin
...
// NewMsgMerkleBlock returns a new ExchangeCoin merkleblock message that conforms to
