...
// MsgPing implements the Message interface and represents a ExchangeCoin ping
// message.
//
...
// NewMsgPing returns a new ExchangeCoin ping message that conforms to the Message
