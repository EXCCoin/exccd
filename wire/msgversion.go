...
const DefaultUserAgent = "/exccwire:0.3.0/"

// MsgVersion implements the Message interface and represents a ExchangeCoin version
...
// NewMsgVersion returns a new ExchangeCoin version message that conforms to the
...
// and local address from conn and returns a new ExchangeCoin version message that
