...
// a single ExchangeCoin headers message.
const MaxBlockHeadersPerMsg = 2000

// MsgHeaders implements the Message interface and represents a ExchangeCoin headers
...
// NewMsgHeaders returns a new ExchangeCoin headers message that conforms to the
