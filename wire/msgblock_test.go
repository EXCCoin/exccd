...
func TestBlockHash(t *testing.T) {
	// Block 1 hash.
	hashStr := "2d1592337fef6c650de2465c8006d1907d843c65788ae7c04b8ca7141ee4cc22"
	wantHash, err := chainhash.NewHashFromStr(hashStr)
	if err != nil {
		t.Errorf("NewHashFromStr: %v", err)
	}
...
func TestBlockOverflowErrors(t *testing.T) {
	//This test started to miss error in message format after adding EquihashSolution to serialized block bytes
	t.SkipNow()
