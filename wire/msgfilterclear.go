...
// MsgFilterClear implements the Message interface and represents a ExchangeCoin
...
// NewMsgFilterClear returns a new ExchangeCoin filterclear message that conforms to the Message
