...
// MsgNotFound defines a ExchangeCoin notfound message which is sent in response to
...
// NewMsgNotFound returns a new ExchangeCoin notfound message that conforms to the
