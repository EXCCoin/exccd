...
// MsgFilterAdd implements the Message interface and represents a ExchangeCoin
...
// NewMsgFilterAdd returns a new ExchangeCoin filteradd message that conforms to the
