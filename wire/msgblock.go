...
// MsgBlock implements the Message interface and represents a ExchangeCoin
...
// BtcDecode decodes from the ExchangeCoin wire protocol as it was sent across the
...
// the ExchangeCoin wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new ExchangeCoin block message that conforms to the
