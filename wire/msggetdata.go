...
// MsgGetData implements the Message interface and represents a ExchangeCoin
...
// NewMsgGetData returns a new ExchangeCoin getdata message that conforms to the
...
// NewMsgGetDataSizeHint returns a new ExchangeCoin getdata message that conforms to
