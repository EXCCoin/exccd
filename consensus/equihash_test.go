...
func createMiningTests() []miningTest {
	return []miningTest{
		...
		{96, 5, []byte("block header"), 1, [][]int{
			[]int{1911, 96020, 94086, 96830, 7895, 51522, 56142, 62444, 15441, 100732, 48983, 64776, 27781, 85932, 101138, 114362, 4497, 14199, 36249, 41817, 23995, 93888, 35798, 96337, 5530, 82377, 66438, 85247, 39332, 78978, 83015, 123505},
		}},
		{96, 5, []byte("block header"), 2, [][]int{
			[]int{165, 27290, 87424, 123403, 5344, 35125, 49154, 108221, 8882, 90328, 77359, 92348, 54692, 81690, 115200, 121929, 18968, 122421, 32882, 128517, 56629, 88083, 88022, 102461, 35665, 62833, 95988, 114502, 39965, 119818, 45010, 94889},
		}},
...
func (mt *miningTest) header() []byte {
	return testHeader(mt.I, mt.nonce)
}
