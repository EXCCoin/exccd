...
const (
	...
	DefaultMinRelayTxFee = exccutil.Amount(1e5)
...
// pool and relayed.
func calcMinRequiredTxRelayFee(serializedSize int64, minRelayTxFee exccutil.Amount) int64 {
	...
	if minFee < 0 || minFee > exccutil.MaxAmount {
		minFee = exccutil.MaxAmount
	}
...
func checkInputsStandard(tx *exccutil.Tx, txType stake.TxType, utxoView *blockchain.UtxoViewpoint) error {
...
func isDust(txOut *wire.TxOut, minRelayTxFee exccutil.Amount) bool {
...
func checkTransactionStandard(tx *exccutil.Tx, txType stake.TxType, height int64,
	medianTime time.Time, minRelayTxFee exccutil.Amount,
