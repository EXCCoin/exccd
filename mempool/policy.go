...
const (
	...
	DefaultMinRelayTxFee = excutil.Amount(1e5)
...
// pool and relayed.
func calcMinRequiredTxRelayFee(serializedSize int64, minRelayTxFee excutil.Amount) int64 {
	...
	if minFee < 0 || minFee > excutil.MaxAmount {
		minFee = excutil.MaxAmount
	}
...
func checkInputsStandard(tx *excutil.Tx, txType stake.TxType, utxoView *blockchain.UtxoViewpoint) error {
...
func isDust(txOut *wire.TxOut, minRelayTxFee excutil.Amount) bool {
...
func checkTransactionStandard(tx *excutil.Tx, txType stake.TxType, height int64,
	medianTime time.Time, minRelayTxFee excutil.Amount,
