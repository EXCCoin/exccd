...
// arguments returns an array of arguments that be used to launch the exccd
// process.
...
// to the exccd process that is launched via Start().
...
// stop interrupts the running exccd process process, and waits until it exits
...
// shutdown terminates the running exccd process, and cleans up all
