...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/EXCCoin/exccd/peer)
...
```bash
$ go get -u github.com/EXCCoin/exccd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/EXCCoin/exccd/peer#example-package--NewOutboundPeer)  
