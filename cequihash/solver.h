...
int solve_485(unsigned char* input, u32 input_len, uint32_t nonce, void* userData);
int solve_965(unsigned char* input, u32 input_len, uint32_t nonce, void* userData);
int solve_1445(unsigned char* input, u32 input_len, uint32_t nonce, void* userData);
int solve_2009(unsigned char* input, u32 input_len, uint32_t nonce, void* userData);
